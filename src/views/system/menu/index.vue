  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        <!-- Search -->
        <el-input v-model="query.fuzzy" clearable size="small" placeholder="模糊搜索" style="width: 200px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
    ...
    <el-dialog append-to-body :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="580px">
      <el-form ref="form" :inline="true" :model="form" :rules="rules" size="small" label-width="80px">
        <el-form-item label="Type" prop="type">
          <el-radio-group v-model="form.type" size="mini" style="width: 178px">
            <el-radio-button label="0">TOC</el-radio-button>
        ...
        <el-form-item v-show="form.type.toString() !== '2'" label="External link" prop="iframe">
        ...
        <el-form-item v-show="form.type.toString() !== '2'" label="Visible" prop="hidden">
          <el-radio-group v-model="form.hidden" size="mini">
            <el-radio-button label="false">Yes</el-radio-button>
            <el-radio-button label="true">No</el-radio-button>
          </el-radio-group>
        </el-form-item>
        <el-form-item v-if="form.type.toString() !== '2'" label="Title" prop="title">
        ...
        <el-form-item v-show="form.type.toString() !== '0'" label="Permission" prop="permission">
          <el-input v-model="form.permission" :disabled="form.iframe" placeholder="Authority ID" style="width: 178px;" />
        </el-form-item>
        <el-form-item v-if="form.type.toString() !== '2'" label="URL" prop="path">
          <el-input v-model="form.path" placeholder="Routing address" style="width: 178px;" />
        </el-form-item>
        ...
        <el-form-item v-show="!form.iframe && form.type.toString() === '1'" label="Component name" prop="componentName">
          <el-input v-model="form.componentName" style="width: 178px;" placeholder="Name field in matching component" />
        </el-form-item>
        <el-form-item v-show="!form.iframe && form.type.toString() === '1'" label="Component path" prop="component">
          <el-input v-model="form.component" style="width: 178px;" placeholder="Component path" />
        </el-form-item>
        <el-form-item label="Superior category" prop="pid">
          <treeselect
            v-model="form.pid"
            :options="menus"
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button :loading="crud.status.cu === 2" type="primary" @click="crud.submitCU">OK</el-button>
      </div>
    </el-dialog>
    <!-- Table rendering -->
    <el-table
